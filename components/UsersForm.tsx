        ...
        <div className=''>
            <form action={FormAction} className='space-y-4'>
                <div className='flex flex-col gap-1'>
                    ...
                    <input type="text" name="nama_user" id="nama_user" placeholder='Nama...' className='outline rounded-sm pl-1 h-8 ' />
                ...
                <div className='flex flex-col gap-1'>
                    ...
                    <input type="text" name="telp" id="telp" placeholder='No Telp...' className='outline rounded-sm pl-1 h-8' />
